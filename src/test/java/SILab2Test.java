...
class SILab2Test {
    ...
    void multipleCondition(){
        ...
        //prv if - test slucai
        Time time1 = new Time(-15, 10,10); //T || X
        ...
        Time time2 = new Time(30, 10, 10); //F || T
